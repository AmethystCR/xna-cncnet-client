...
namespace DTAConfig.OptionPanels
{
    class DisplayOptionsPanel : XNAOptionsPanel
    {
        ...
        public override void Initialize()
        {
            ...
            lblCustomIngameResolution.ClientRectangle = new Rectangle(tbIngameResolutionX.Right + 7, lblIngameResolution.Y , 0, 0);
            ...
            chkCustomIngameResolution.ClientRectangle = new Rectangle(lblIngameResolution.X,
                ddIngameResolution.Bottom + 14, 0, 0);
            chkCustomIngameResolution.Text = "Custom Ingame Resolution".L10N("Client:DTAConfig:CustomIngameResolution");
        ...
        public override bool Save()
        {
            ...
            if (chkCustomIngameResolution.Checked)
            {
                IniSettings.IngameScreenWidth.Value = int.Parse(tbIngameResolutionX.Text);
                IniSettings.IngameScreenHeight.Value = int.Parse(tbIngameResolutionY.Text);
