...
namespace DTAClient.DXGUI.Multiplayer.GameLobby
{
    ...
    {
        public static string GeneratorPath = ProgramConstants.GetBaseResourcePath() + "Tools\\RandomMapGenerator\\";
        ...
        public XNAClientCheckBox chkRenderFullMap;
        ...
        public override void Initialize()
        {
            ...
            lblDescription.Text = "Generate Random Map".L10N("Client:Main:GenerateRandomMap");

            AddChild(lblDescription);

            lblDescription.CenterOnParent();
            lblDescription.ClientRectangle = new Rectangle(lblDescription.X, 12, lblDescription.Width, lblDescription.Height);
            ...
            btnGenerateMap.Text = "Generate".L10N("Client:Main:Generate");
            ...
            btnCancel.Text = "Cancel".L10N("Client:Main:RmCancel");
            ...
            lblMapMode.Text = "Map Theater: ".L10N("Client:Main:MapTheater");
            AddChild(lblMapMode);
            ...
            {
                item.Tag = item.Text;
                item.Text = item.Text.L10N($"Client:Main:RandomMap:{item.Text}");
            }
            ...
            lblMapSize.Text = "Map Size: ".L10N("Client:Main:MapSize");
            AddChild(lblMapSize);
            ...
            ddMapSize.AddItem("Huge".L10N("Client:Main:SizeHuge"));
            ddMapSize.AddItem("Large".L10N("Client:Main:SizeLarge"));
            ddMapSize.AddItem("Medium".L10N("Client:Main:SizeMedium"));
            ddMapSize.AddItem("Small".L10N("Client:Main:SizeSmall"));
            ...
            lblPlayerLocation.Text = "PlayerCount and Locations: ".L10N("Client:Main:PlayerCountLocations");
            ...
            lblPlayerNW.Text = "NorthWest: ".L10N("Client:Main:PlayerNW");
            ...
            lblPlayerN.Text = "North: ".L10N("Client:Main:PlayerN");
            AddChild(lblPlayerN);
            ...
            lblPlayerNE.Text = "NorthEast: ".L10N("Client:Main:PlayerNE");
            ...
            lblPlayerE.Text = "East: ".L10N("Client:Main:PlayerE");
            AddChild(lblPlayerE);
            ...
            lblPlayerSE.Text = "SouthEast: ".L10N("Client:Main:PlayerSE");
            ...
            lblPlayerS.Text = "South: ".L10N("Client:Main:PlayerS");
            AddChild(lblPlayerS);
            ...
            lblPlayerSW.Text = "SouthWest: ".L10N("Client:Main:PlayerSW");
            ...
            lblPlayerW.Text = "West: ".L10N("Client:Main:PlayerW");
            AddChild(lblPlayerW);
            ...
            chkDamagedBuilding.Text = "Damaged Building".L10N("Client:Main:DamagedBuilding");
            ...
            chkNoThumbnail.Text = "No Thumbnail".L10N("Client:Main:NoThumbnail");
            //AddChild(chkNoThumbnail);

            chkRenderFullMap = new XNAClientCheckBox(WindowManager);
